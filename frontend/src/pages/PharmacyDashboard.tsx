...
export default function PharmacyDashboard() {
  ...
  const dispenseRx = async (rx: Prescription) => {
    ...
    if (existingDispense) {
      await updatePharmacy(existingDispense.id, { dispensed: true, medicine_cost: String(costs[rx.id] || 0) })
    } else {
  ...
  return (
    <div className="relative min-h-screen rounded-2xl border border-slate-800 bg-slate-950/60 backdrop-blur-sm overflow-hidden p-6">
      ...
      <div 
        ...
        style={{ backgroundImage: `url('https://images.unsplash.com/photo-1586015555751-63bb77f4322a?auto=format&fit=crop&w=1600&q=80')` }}
      />
